...
class QuantitySeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('quantities')->insert([
            ...
            ['quantity_id' => 12, 'name' => '50 Metros', 'created_at' => now(), 'updated_at' => now()],
            ['quantity_id' => 13, 'name' => '100 Metros', 'created_at' => now(), 'updated_at' => now()],
            ['quantity_id' => 14, 'name' => '150 Metros', 'created_at' => now(), 'updated_at' => now()],
            ['quantity_id' => 15, 'name' => '220 Metros', 'created_at' => now(), 'updated_at' => now()],
            ['quantity_id' => 16, 'name' => '300 Metros', 'created_at' => now(), 'updated_at' => now()],
            ['quantity_id' => 17, 'name' => '1 Kilo', 'created_at' => now(), 'updated_at' => now()],
            ['quantity_id' => 18, 'name' => '5 Kilos', 'created_at' => now(), 'updated_at' => now()],
            ['quantity_id' => 19, 'name' => '25 Kilos', 'created_at' => now(), 'updated_at' => now()],
        ]);
